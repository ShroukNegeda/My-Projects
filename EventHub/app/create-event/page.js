...
import Component from './CreateEventPage';
...
export default function Page() {
  ...
  // If user is not an organizer after hydration, redirect to login
  useEffect(() => {
  if (app.userRole === null) return;

  if (app.userRole !== 'Organizer') {
    router.push('/login');
  }
}, [app.userRole]);
